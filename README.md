...
| [IdealWebs](OpenProblemFormalizations/IdealWebs/CountableLevels.lean) | Hernández-Hernández–Hrušák–Rivas-González, *The bounded topology*, Conjecture 4.14 | 递增遗传层覆盖中的序列 web 固定层引理；拉回理想中序列 web 的直接像引理 | E05 的一般二分法及 flat 理想判别仍为纸笔审计，未形式化 |
