...
run_elab do
  ...
  let required : Array Name := #[
    ...
    `OpenProblemFormalizations.IdealSpectra.CohesiveIdeal.directed_of_tukeyLE,
    `OpenProblemFormalizations.IdealSpectra.CohesiveIdeal.rectangular_representative_forces_comparable,
    `OpenProblemFormalizations.IdealSpectra.CohesiveIdeal.rectangular_representable_iff,
